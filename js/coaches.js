        ...
        if (cardsContainer) {
          ...
          card.innerHTML = `
            ...
            <div class="coach-card-bottom-grid">
              <div class="coach-meta-col coach-meta-col-location">
              ...
              <div class="coach-meta-col coach-meta-col-date">
                <div class="coach-meta-val">
              ...
              <div class="coach-meta-col coach-meta-col-phone">
                <div class="coach-meta-val coach-meta-val-phone">
                  ...
                  <span class="coach-phone-val">${phoneFormatted}</span>
                </div>
